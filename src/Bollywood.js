      ...
      <h1 className='Top_posts'>Top Posts</h1>
          ...
          <div className='Second_div'>
            <div className='Top_stories_Section'>
               {contextData.filter((e)=>e.category === "Bollywood").map((item,index)=>{
                return(
                  <div>
                      <div className='k'>
             ...
             <div className='Top_Posts_Section'>
                        {contextData.filter((e)=>e.category === "South_News").map((item,index)=>{
                          // {console.log(item.name)}
                        return(
                          <>
                            <div key={item.index} className='Top_post_Series'>
                                <NavLink to={`/Dynamic/${item.id}`}>
                                  <img className='Top_Post_images secondTopbolly'  src={item.image} alt='not found'/>
                                  <br/>
                                  <h3>{item.name}</h3>
                                  <br/>
                                </NavLink>
                        ...
                        <div>
                        {contextData.filter((e)=>e.category === "Advertisement1").map((item,index)=>{
                          return(
